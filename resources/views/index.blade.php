    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-5">
                <img src="{{asset('imgs/index/phone_3.png')}}" alt="Image placeholder" class="img-fluid">
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <div class="pb_slider_nav js-pb_slider_nav2">
                                <div class="author">
                                    <img class="img-fluid rounded-circle" src="{{asset('imgs/index/person_1.jpg')}}" alt="Generic placeholder image">
                                </div>
                                <div class="author">
                                    <img class="img-fluid rounded-circle" src="{{asset('imgs/index/person_5.jpg')}}" alt="Generic placeholder image">
                                </div>
                                <div class="author">
                                    <img class="img-fluid rounded-circle" src="{{asset('imgs/index/person_2.jpg')}}" alt="Generic placeholder image">
                                </div>
                                <div class="author">
                                    <img class="img-fluid rounded-circle" src="{{asset('imgs/index/person_6.jpg')}}" alt="Generic placeholder image">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md">
                <div class="pb_pricing_v1 p-5 border text-center bg-white">
                    ...
                    <p class="mb-0"><a href="#" role="button" class="btn btn-secondary">Try it Free</a></p>
                </div>
            </div>
            <div class="col-md">
                <div class="pb_pricing_v1 p-5 border border-primary text-center bg-white">
                    <h3>Basic</h3>
                    <span class="price"><sup>$</sup>5</span>
...
<section class="pb_xl_py_cover overflow-hidden pb_slant-light pb_gradient_v1 cover-bg-opacity-8"  style="background-image: url({{asset('imgs/index/1900x1200_img_5.jpg')}})">
    <div class="container">
        <div class="row align-items-center justify-content-center">
